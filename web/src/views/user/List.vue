<template>
  <div class="backyard-user-list animated fadeIn">
    <div class="row">
      ...
      <div class="col-md-4 text-right" v-if="accessControl.role === UserRole.ADMINISTRATOR">
...
<!--									</a>-->
									...
									<a href="javascript:void(0)"
                     v-if="accessControl.role === UserRole.ADMINISTRATOR && userItem.isActive && user.uuid!==userItem.uuid"
