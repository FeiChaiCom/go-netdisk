  ...
  <nav ref="menuNav" class="side-navigation" :class="{'show-drawer':showDrawer}" @click.stop.prevent="eatClick">
    <div class="sidebar-collapse">
      ...
      <ul class="nav mt20">
        ...
        <li v-if="accessControl.role === UserAclRole.GUEST">
...
<!--        <li v-if="accessControl.role === UserAclRole.GOD">-->
...
<!--        <li v-if="accessControl.role === UserAclRole.ADMINISTRATOR">-->
<!--          <router-link to="/project/list" :class="{'custom-active':isCustomActive('/project/list')}">-->
<!--            <i class="w14 fa fa-sitemap xfa-hospital-o"></i>-->
...
<!--        <li v-if="accessControl.role === UserAclRole.ADMINISTRATOR || accessControl.role === UserAclRole.PROJECT_ADMIN">-->
<!--          <router-link to="/permission/list" :class="{'custom-active':isCustomActive('/permission/list')}">-->
<!--            <i class="w14 fa fa-users"></i>-->
<!--            <span>{{ $t('layout.permission') }}</span>-->
<!--          </router-link>-->
<!--        </li>-->
...
<script>
  ...
  import {UserRole} from "../../model/permission/UserAclRole"
  ...
  export default {
    ...
    computed: {
      ...mapState({
        accessControl: state => state.accessControl,
        // showDrawer: state => state.config.showDrawer,
    ...
    methods: {
      ...
      goToProfile() {
        ...
        if (this.accessControl.role === UserAclRole.GUEST) {
