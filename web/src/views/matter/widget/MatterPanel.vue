  ...
  <div class="widget-matter-panel">
    ...
    <div @click.stop.prevent="clickRow">
      ...
      <div class="media">
        ...
        <div class="pull-left">
          <div class="left-part">
            <span class="basic-span" v-if="!matter.dir">
...
<!--                 @click.stop.prevent="clipboard"></i>-->
              <i class="fa fa-download btn-action text-primary"
                 v-if="accessControl.role !=='PROJECT_PROVIDER'"
                 :title="$t('matter.download')"
        ...
        <div class="media-body">
          ...
          <div class="middle-part">
            ...
            <span class="matter-name"
                ...
                {{matter.name}}
<!--              <i class="fa fa-unlock" v-if="!matter.dir && !matter.privacy" :title="$t('matter.publicFileEveryoneCanVisit')"></i>-->
              </span>
    ...
    methods: {
      clickRow() {
        ...
        if (this.director.isEditing()) {
          console.error('文件或目录处于编辑状态，不予执行')
          return
        }
