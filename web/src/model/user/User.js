...
export default class User extends BaseEntity {
  ...
  static URL_PERMISSION = '/api/permission/'
  ...
  constructor(args) {
    ...
    this.lastIp = null
    this.lastTime = null
    //默认大小限制256Mb(268435456)
    this.sizeLimit = 1024 * 1024 * 256
    this.totalSize = 0
  ...
  getAccessControl(successCallback, errorCallback) {
    let that = this
    this.httpGet(User.URL_PERMISSION + 'self_permissions/', {}, function (response) {
      // that.render(response.data.data)
      that.safeCallback(successCallback)(response)
    }, errorCallback)
  }
