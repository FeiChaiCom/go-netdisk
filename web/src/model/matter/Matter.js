...
export default class Matter extends BaseEntity {
  ...
  static URL_MATTER_CREATE_DIRECTORY = '/api/matter/create_directory/'
  static URL_MATTER_DELETE = '/api/matter/delete/'
  static URL_MATTER_DELETE_BATCH = '/api/matter/batch_delete/'
  ...
  getDownloadUrl(downloadTokenUuid = null) {
    return currentHost() + `/api/matter/${this.uuid}/download/` + `?name=${this.name}` + (downloadTokenUuid ? '&downloadTokenUuid=' + downloadTokenUuid : '')
  }
